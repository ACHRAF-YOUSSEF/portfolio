...
const Hero = () => {
  ...
  return (
    <section
      id="top"
      className="relative w-full min-h-[calc(100vh-82px)] mx-auto flex items-center py-8 sm:py-12"
    >
      <div className={`${styles.paddingX} max-w-7xl mx-auto w-full`}>
        <div className="grid md:grid-cols-[1.2fr_0.8fr] gap-6 lg:gap-10 items-center">
          ...
          <div className="hero-terminal shell-card p-4 sm:p-5">
      ...
      <div className="absolute bottom-4 sm:bottom-6 w-full hidden sm:flex justify-center items-center">
        <a href="#about" aria-label="Scroll to About">
          <div className="w-8.75 h-16 rounded-3xl border-2 border-[#4fb3df81] flex justify-center items-start p-2">
            <div className="hero-scroll-dot w-3 h-3 rounded-full bg-[#7ad1f7] mb-1" />
          </div>
        </a>
      </div>
    </section>
